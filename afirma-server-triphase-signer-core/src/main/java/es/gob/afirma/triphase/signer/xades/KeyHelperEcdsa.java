...
final class KeyHelperEcdsa implements KeyHelper {
	...
	private static final String deriveCurveName(final PublicKey publicKey) throws NoSuchAlgorithmException {
	    if(publicKey instanceof java.security.interfaces.ECPublicKey){
	        ...
	        // BC 1.71+ removed the (spec, boolean withCompression) overload of EC5Util.convertSpec.
	        // The single-arg form converts a java.security.spec.ECParameterSpec to org.bouncycastle.jce.spec.ECParameterSpec.
